...
class Plugin extends Plugin_Base {
	...
	public function register_scripts() {
		...
		if ( Tackle_Post_Type::SLUG === $post->post_type ) {
			...
			wp_register_script( 'tackle-foundation-jquery', plugin_dir_url( __DIR__ ) . 'js/vendor/foundation/jquery.js', array( 'jquery' ), 0.1, true );
			wp_register_script( 'tackle-what-input', plugin_dir_url( __DIR__ ) . 'js/vendor/foundation/what-input.js', array( 'jquery' ), 0.1, true );
			wp_register_script( 'tackle-foundation', plugin_dir_url( __DIR__ ) . 'js/vendor/foundation/foundation.js', array( 'jquery' ), 0.1, true );
			wp_register_script( 'tackle-foundation-app', plugin_dir_url( __DIR__ ) . 'js/vendor/foundation/app.js', array( 'jquery' ), 0.1, true );
			wp_register_script( 'tackle-bpopup', plugin_dir_url( __DIR__ ) . 'js/vendor/jquery.bpopup.min.js', array( 'jquery' ), 0.1, true );
			wp_register_script( 'tackle-bootstrap', plugin_dir_url( __DIR__ ) . 'js/vendor/bootstrap/bootstrap.min.js', array( 'jquery' ), 0.1, true );
			...
			wp_enqueue_script( 'tackle-bootstrap' );
	...
	public function register_styles() {
		...
		if ( Tackle_Post_Type::SLUG === $post->post_type ) {
			...
			wp_register_style( 'tackle-bootstrap-styles', plugin_dir_url( __DIR__ ) . 'css/vendor/bootstrap/bootstrap.min.css' );
			...
			wp_enqueue_style( 'tackle-bootstrap-styles' );
		}
	}
}